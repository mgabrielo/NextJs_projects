    ...
    <div className='flex flex-row items-center justify-between'>
        ...
        <div className='flex flex-row items-center gap-4'>
            <div onClick={onReduce} className='w-10 h-10 rounded-full border-[1px] border-neutral-400 flex items-center justify-center
             text-neutral-600 cursor-pointer hover:opcaity-80 transition '>
                <AiOutlineMinus/> 
             </div>
             <div className='font-light text-neutral-600 text-xl'>{value}</div>
             <div onClick={onAdd} className='w-10 h-10 rounded-full border-[1px] border-neutral-400 flex items-center justify-center
             text-neutral-600 cursor-pointer hover:opcaity-80 transition '>
                <AiOutlinePlus/> 
             </div> 
        </div>
